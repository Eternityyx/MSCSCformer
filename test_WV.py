...
if __name__ == "__main__":
    ...
    SaveReducedDataPath = f"../../disk3/xmm/test_result/WV3_Reduced/{NET}_{condition}_{checkpoint_condition}.mat"
    ...
    SaveFullDataPath = f"../../disk3/xmm/test_result/WV3_Full/{NET}_{condition}_{checkpoint_condition}.mat"
