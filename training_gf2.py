...
NET = 'transformer'
condition = f'v1_gf2_{LR}_{iter_num}_{scale}_{dim}_{heads}_{num_blocks}'
...
if __name__ == "__main__":
    ...
    FullData = 'test_gf2_OrigScale_multiExm2.h5'
    ...
    savemat_val_data_name = f'../../disk3/xmm/{NET}/gf2_{condition}_val_data.mat'
    savemat_test_data_name = f'../../disk3/xmm/{NET}/gf2_{condition}_test_data.mat'
    SaveFullDataPath = f"../../disk3/xmm/{NET}/{NET}_{condition}_{FullData}"
    savenet_data_name = checkpoint + f'/{{}}_gf2_{condition}_{{}}.pth'
    ...
    # 邮件主题
    subject_content = f"""{NET}_{condition}_gf2数据集训练结果"""
    # 设置发送者,注意严格遵守格式,里面邮箱为发件人邮箱
