...
if __name__ == "__main__":
    ##### read dataset #####
    test_bs = 1
    tmpPath = checkpoint + f"WV3_{condition}_{checkpoint_condition}.pth"
    ReducedData = 'test_wv2_multiExm2'

    SaveReducedDataPath = f"../../disk3/xmm/test_result/WV2_Reduced/{NET}_{condition}_reduce.mat"
    ...
    FullData = 'test_wv2_OrigScale_multiExm2'
    SaveFullDataPath = f"../../disk3/xmm/test_result/WV2_Full/{NET}_{condition}_full.mat"
    ...
    print(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), f'{NET} test wv2 completely!')
