...
if __name__ == "__main__":
    ##### read dataset #####
    test_bs = 1
    tmpPath = checkpoint + f"gf2_{condition}_{checkpoint_condition}.pth"
    ReducedData = 'test_gf2_multiExm2'

    SaveReducedDataPath = f"../../disk3/xmm/test_result/GF2_Reduced/{NET}_{condition}_{checkpoint_condition}.mat"
    ...
    SaveFullDataPath = f"../../disk3/xmm/test_result/GF2_Full/{NET}_{condition}_{checkpoint_condition}.mat"
